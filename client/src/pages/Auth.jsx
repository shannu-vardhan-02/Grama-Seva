...
import { Eye, EyeOff, Upload, Landmark } from "lucide-react";
import { GoogleLogin } from '@react-oauth/google';

const S = {
  label: {
    display: "block", fontSize: "12px", fontWeight: 600,
    color: "#141413", letterSpacing: "-0.007em", marginBottom: "6px",
  },
  input: {
    width: "100%", padding: "11px 15px", background: "#faf9f5",
    color: "#141413", border: "1px solid #e6dfd8", borderRadius: "8px",
    fontSize: "15px", fontFamily: "'Inter', sans-serif", outline: "none",
    transition: "border-color 0.15s, box-shadow 0.15s", boxSizing: "border-box",
  },
  inputFocus: {
    borderColor: "#cc785c", boxShadow: "0 0 0 3px rgba(204,120,92,0.15)",
  },
  select: {
    width: "100%", padding: "11px 15px", background: "#faf9f5",
    color: "#141413", border: "1px solid #e6dfd8", borderRadius: "8px",
    fontSize: "15px", fontFamily: "'Inter', sans-serif", outline: "none", cursor: "pointer",
  },
  btnPrimary: {
    display: "flex", alignItems: "center", justifyContent: "center",
    width: "100%", padding: "13px 22px", background: "#cc785c", color: "#ffffff",
    border: "none", borderRadius: "8px", fontSize: "15px", fontWeight: 500,
    letterSpacing: "-0.01em", cursor: "pointer", transition: "background 0.15s, transform 0.1s",
...
export default function Auth() {
  ...
  return (
    <div style={{
      ...
      fontFamily: "'Inter', -apple-system, sans-serif", background: "#faf9f5",
      flexDirection: "column",
    }}>
      {/* ── MOBILE HEADER (visible only on mobile via CSS) ── */}
      <div className="auth-mobile-header" aria-hidden="false">
        <div style={{
          width: "32px", height: "32px", background: "#cc785c", borderRadius: "8px",
          display: "flex", alignItems: "center", justifyContent: "center",
        }}>
          <Landmark size={16} color="#fff" />
        </div>
        <div>
          <div style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "18px", color: "#faf9f5", letterSpacing: "-0.01em" }}>
            Grama Seva
          </div>
          <div style={{ fontSize: "11px", color: "#a09d96" }}>Rural Service Portal</div>
        </div>
      </div>

      {/* ── MAIN ROW: left panel + form ── */}
      <div style={{ display: "flex", flex: 1 }}>

        {/* LEFT — brand panel (desktop only via CSS) */}
        <div className="auth-left-panel" style={{
          background: "#181715", color: "#faf9f5",
          width: "420px", flexShrink: 0,
          flexDirection: "column", padding: "56px 44px",
          ...
          <div style={{ height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
              <div style={{ marginBottom: "40px" }}>
                <div style={{
                  width: "40px", height: "40px", background: "#cc785c", borderRadius: "10px",
        ...
        <div className="auth-right-panel">
          <div className="auth-form-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  />
                  <button type="button" onClick={() => setShowPwd(!showPwd)} className="no-min-height" style={{
                    position: "absolute", right: "14px", top: "50%", transform: "translateY(-50%)",
                    background: "none", border: "none", cursor: "pointer", color: "#8e8b82", display: "flex", minHeight: "unset",
                  }}>
              ...
              {!isLogin && (
                <div style={{ marginBottom: "20px" }}>
                  ...
                  <div className="auth-role-buttons" style={{ display: "flex", gap: "10px" }}>
                  ...
                  {role === "Worker" && (
                    <div style={{ marginTop: "16px", padding: "16px", background: "#faf9f5", border: "1px solid #e6dfd8", borderRadius: "11px" }}>
                      ...
                      <div style={{ marginBottom: "14px" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
                          {[
                            ...
                            <label key={s.id} className="no-min-height" style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "13px", color: "#141413", cursor: "pointer", minHeight: "unset" }}>
                              <input
                                type="checkbox"
                      ...
                      {/* Experience + Address — collapse to 1 col on mobile */}
                      <div className="auth-worker-grid-2" style={{ marginBottom: "12px" }}>
                        <div>
                      ...
                      <div>
                        ...
                        <div style={{
                          border: "1px dashed #e6dfd8", borderRadius: "8px", padding: "16px",
                          textAlign: "center", position: "relative", cursor: "pointer", background: "#ffffff",
                        }}>
            ...
            <div style={{ textAlign: "center", marginTop: "20px" }}>
              <button onClick={() => setIsLogin(!isLogin)} className="no-min-height" style={{
                background: "none", border: "none", cursor: "pointer",
                fontSize: "14px", color: "#0066cc", letterSpacing: "-0.013em", minHeight: "unset",
              }}>
